...
export const Projects = () => {
  return <section className="pb-16 lg:py-24">
   ...
   eyebrow="Browse through My Work"
    description="See how transformed concepts into real world digital expriences ." 
    />
      <div className="mdt-10 md:mt-20 flex flex-col mt-10 gap-20">
        ...
        style={{
          top: `calc(64px + ${projectindex * 40}px`
           ...
           <div className="lg:grid lg:grid-cols-2 lg:gap-16">
            ...
            md:w-auto px-6 font-semibold inline-flex items-center justify-center gap-2 mt-8">  
                <span>Visit Live Site</span>
                <ArrowUpRightIcon className="size-4"/>
            </button>
            </a>
            </div>
            <div className="relative lg:mt-0 lg:pt-8">
